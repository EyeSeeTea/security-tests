...
DEFAULT_VEX = "vex_yarn4.json"
DEFAULT_VDR = "bom_yarn4.json"
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Merge VEX and VDR vulnerabilities (Yarn4) and export to CSV."
    )
    parser.add_argument("--vex", default=DEFAULT_VEX, help="Path to vex_yarn4.json")
    parser.add_argument("--vdr", default=DEFAULT_VDR, help="Path to bom_yarn4.json")
